...
const TipCard = ({ tip, onEdit, onDelete }) => {
                  ...
                  <div className="p-6">
                        <div className="flex justify-between items-start mb-4">
                              <div className="flex-1">
                                    ...
                                    <h3 className="text-xl font-bold text-gray-900 mb-2">{`${tip.title.slice(
                                          0,
                                          20
                                    )}...`}</h3>
                              </div>
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                              ...
                              <button
                                    className={`flex items-center gap-2 px-4 bg-green-100 py-2 rounded-lg font-medium transition-all`}
                              >
                                    <ThumbsUp size={16} />
                                    <span>{tip.likes}</span>
                              </button>
