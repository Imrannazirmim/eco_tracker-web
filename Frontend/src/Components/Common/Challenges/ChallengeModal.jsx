      ...
      const handleSubmit = async (e) => {
            ...
            try {
                  ...
                  const submitData = {
                        ...
                        howToParticipate:
                              formData.howToParticipate.length > 0
                  ...
                  await axiosSecure.post("/api/challenges", submitData);
                                    ...
                                    >
                                          ...
                                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                ...
                                                <div>
                                                      ...
                                                      <input
                                                            ...
                                                            onChange={(e) =>
                                                                  handleChange("impactMetric", e.target.value)
                                                            }
                                                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                                          ...
                                          <div>
                                                ...
                                                <textarea
                                                      ...
                                                      onChange={(e) =>
                                                            handleChange("environmentalImpact", e.target.value)
                                                      }
                                                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
