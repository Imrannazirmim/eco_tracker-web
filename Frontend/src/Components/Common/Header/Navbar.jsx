                                        ...
                                        <div className='absolute top-20 right-14 z-10 cursor-pointer'>
                                            {showMenu && (
                                                    <div className='flex flex-col border border-gray-300 bg-gray-200 rounded-xl p-4'>
                                                        <h2 className='text-green-800 py-1 px-2 rounded-md hover:bg-gray-100'>Imran Nazir Mim</h2>
                                                        <h3 className='text-gray-600 py-1 px-2 rounded-md hover:bg-gray-100'>name@gmail.com</h3>
                                                        <hr className='text-gray-300 mt-1'/>
                                                        <span className='text-green-800 py-1 px-2 rounded-md hover:bg-gray-100'>Dashboard</span>
                                                        <p className='text-green-800 py-1 px-2 rounded-md hover:bg-gray-100'>Profile Info</p>
                                                    </div>
                                            )}
                                        </div>
