...
const AccountSettings = () => {
  ...
  const handlePasswordChange = async () => {
    ...
    try {
      ...
      setSecurityData({ newPassword: '', confirmPassword: '', twoFactorEnabled: securityData.twoFactorEnabled });
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-1">Manage your personal details, security, and preferences</p>
        </div>
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-12 h-12 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full flex items-center justify-center">
                    {personalInfo.photoURL ? (
                      <img src={personalInfo.photoURL} alt="Profile" className="w-12 h-12 rounded-full object-cover" />
                    ) : (
                  ...
                  <div>
                    <p className="font-semibold text-gray-900">{personalInfo.fullName || 'User'}</p>
          ...
          <div className="flex-1">
            ...
            {activeSection === 'personal' && (
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <p className="text-gray-600 text-sm mb-6">Update your personal details and public profile</p>
                ...
                <div className="mb-6">
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="w-24 h-24 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full flex items-center justify-center">
                      {personalInfo.photoURL ? (
                        <img src={personalInfo.photoURL} alt="Profile" className="w-24 h-24 rounded-full object-cover" />
                      ) : (
                    ...
                    <div>
                      ...
                      <button className="ml-2 text-gray-600 hover:text-gray-900 px-4 py-2">Remove</button>
                    </div>
                  </div>
                </div>
            ...
            {activeSection === 'security' && (
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <p className="text-gray-600 text-sm mb-6">Manage your password and account security settings</p>
                ...
                <div className="mb-8">
                  ...
                  >
                    {securityData.twoFactorEnabled ? 'Disable' : 'Enable Security'}
                  </button>
                </div>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between py-3 border-b border-gray-200">
                    <div>
                      <h3 className="font-semibold text-gray-900">Challenge Reminders</h3>
                      <p className="text-sm text-gray-600">Get notified about ongoing challenges</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        type="checkbox"
                        checked={notifications.challengeReminders}
                        onChange={(e) => setNotifications({ ...notifications, challengeReminders: e.target.checked })}
                  ...
                  <div className="flex items-center justify-between py-3 border-b border-gray-200">
                    <div>
                      <h3 className="font-semibold text-gray-900">Community Milestones</h3>
                      <p className="text-sm text-gray-600">Notify me when someone mentions me in the community</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        type="checkbox"
                        checked={notifications.communityMilestones}
                        onChange={(e) => setNotifications({ ...notifications, communityMilestones: e.target.checked })}
                        className="sr-only peer"
                      />
                      <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-green-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-green-500"></div>
                    </label>
                  ...
                  <div className="flex items-center justify-between py-3 border-b border-gray-200">
                    <div>
                      <h3 className="font-semibold text-gray-900">Event Alerts</h3>
                      <p className="text-sm text-gray-600">Get notified about upcoming green events</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        type="checkbox"
                        checked={notifications.eventAlerts}
                        onChange={(e) => setNotifications({ ...notifications, eventAlerts: e.target.checked })}
                        className="sr-only peer"
                      />
                      <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-green-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-green-500"></div>
                    </label>
                  ...
                  <div className="flex items-center justify-between py-3">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Receive news and product update emails from EcoTrack</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        type="checkbox"
            ...
            {activeSection === 'account' && (
              <div className="bg-white rounded-lg shadow-sm p-6">
                <h2 className="text-xl font-bold text-red-600 mb-2">Account Management</h2>
                <p className="text-gray-600 text-sm mb-6">Permanently delete your account and all associated data</p>
